package com.hwaggLee.zs.cp.s11T5;
...
import com.hwaggLee.jsoup.html.HtmlBase;
import com.hwaggLee.utils.UtilsDate;
import com.hwaggLee.utils.UtilsUUID;
import com.hwaggLee.zs.cp.model.Model11T5;
...
public class Html11T5  extends HtmlBase{
	...
	public void printlnInsert(List<Model11T5> list)throws Exception{
		if(list != null && list.size()>0){
			...
			UtilsFile.writerEndAdd("C:\\Users\\huage\\Desktop\\app\\ssq_history.sql", sb.toString());
