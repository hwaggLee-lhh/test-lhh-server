...
@Repository("managercwsjfinancialindexabstract")
public class ManagerCWSJFinancialIndexAbstract extends BaseManager<ModelCWSJFinancialIndexAbstract>{

	@Override
	public Class<ModelCWSJFinancialIndexAbstract> getModelClass() {
		return ModelCWSJFinancialIndexAbstract.class;
	}



	public Page<ModelCWSJFinancialIndexAbstract> findPage(ModelCWSJFinancialIndexAbstract example, PageParam pageParam) {
...
//        dc.addOrder(Order.desc("dataCompiledDate"));
	...
	public ModelCWSJFinancialIndexAbstract findByStockCodeAndEndDate(String stockCode,Date endDate) {
		DetachedCriteria dc = super.getDetachedCriteria();
		dc.add(Restrictions.eq("stockCode", stockCode));
		dc.add(Restrictions.eq("endDate", endDate));
		List<ModelCWSJFinancialIndexAbstract> list = super.findList(dc);
