...
import com.hwaggLee.jsoup.config.ConfigJsoup;
import com.hwaggLee.jsoup.utils.UtilsCollect;
...
public abstract class HtmlBase {
	...
	public Document getDocument(){
		try {
			...
			logger.error(e.getMessage()+";html="+getUrl());
		}
		return null;
	}
	...
	public Document getDocument(String url){
		try {
			...
			logger.error(e.getMessage()+";html="+url);
		}
		return null;
	}

	public Document getDocumentOnce(String url){
		try {
			return UtilsCollect.getDocument(url);
		} catch (Exception e) {
			logger.error(e.getMessage()+";html="+url);
		}
		return null;
